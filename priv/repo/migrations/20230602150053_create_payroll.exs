defmodule Ghr.Repo.Migrations.CreatePayroll do
  ...
  def change do
    create table(:emps, primary_key: false) do
      ...
      add :dept, :text, null: false, default: "Administration" # ADMIN, FACTORY, SALES, BSV
      add :sub_dept, :text, null: false, default: "Worker" # MR, DRIVER, MECHANIC, CEO, MANAGER etc
    ...
    create table(:months_payroll, primary_key: false) do
      add :id, :text, primary_key: true # org_id_YYYYMM_emp_id
